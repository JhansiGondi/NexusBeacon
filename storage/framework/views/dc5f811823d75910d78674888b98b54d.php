...
<?php $__env->startSection('title', 'Converse | Outreach & Syndication'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="py-20 bg-white text-center">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <a href="<?php echo e(route('home')); ?>#contact" class="inline-block px-8 py-4 bg-navy-900 text-white font-bold uppercase tracking-widest rounded hover:bg-gold-600 transition-colors shadow-lg">Start Conversation Campaign</a>
        </div>
    </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\nexus_becon\resources\views/converse.blade.php ENDPATH**/ ?>