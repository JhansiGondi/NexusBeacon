...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Nexus Beacon | Illuminating Enterprise Growth'); ?></title>
    ...
    <nav :class="{ 'py-4 shadow-sm': !scrolled, 'py-3 shadow-md': scrolled }" class="fixed w-full top-0 z-50 glass-nav transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="<?php echo e(route('home')); ?>" class="text-sm font-bold tracking-wide hover:text-gold-400 transition-colors <?php echo e(request()->routeIs('home') ? 'text-gold-400' : 'text-slate-300'); ?>">HOME</a>
                    <a href="<?php echo e(route('about')); ?>" class="text-sm font-medium tracking-wide text-slate-400 hover:text-gold-400 transition-colors <?php echo e(request()->routeIs('about') ? 'text-gold-400' : ''); ?>">ABOUT</a>
                    ...
                    <div class="relative group" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <a href="<?php echo e(route('connect')); ?>" class="block px-6 py-4 hover:bg-navy-700 flex items-start gap-4 group/item transition-colors border-b border-white/5 last:border-0">
                            ...
                            <a href="<?php echo e(route('converse')); ?>" class="block px-6 py-4 hover:bg-navy-700 flex items-start gap-4 group/item transition-colors border-b border-white/5 last:border-0">
                                <div class="mt-1 text-gold-500">
                            ...
                            <a href="<?php echo e(route('convert')); ?>" class="block px-6 py-4 hover:bg-navy-700 flex items-start gap-4 group/item transition-colors border-b border-white/5 last:border-0">
                                <div class="mt-1 text-gold-500">
                    ...
                    <a href="<?php echo e(route('blog')); ?>" class="text-sm font-medium tracking-wide text-slate-400 hover:text-gold-400 transition-colors <?php echo e(request()->routeIs('blog') ? 'text-gold-400' : ''); ?>">BLOG</a>
                    <a href="<?php echo e(route('careers')); ?>" class="text-sm font-medium tracking-wide text-slate-400 hover:text-gold-400 transition-colors <?php echo e(request()->routeIs('careers') ? 'text-gold-400' : ''); ?>">CAREERS</a>
                </div>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-6 py-8 space-y-4">
                <a href="<?php echo e(route('home')); ?>" class="block text-lg font-medium text-white hover:text-gold-500 tracking-wide border-b border-white/10 pb-2">HOME</a>
                <a href="<?php echo e(route('about')); ?>" class="block text-lg font-medium text-white hover:text-gold-500 tracking-wide border-b border-white/10 pb-2">ABOUT</a>
                ...
                <div class="pl-4 space-y-3 border-l-2 border-gold-500/20">
                    <a href="<?php echo e(route('connect')); ?>" class="block text-base text-slate-300 hover:text-white">Connect</a>
                    <a href="<?php echo e(route('converse')); ?>" class="block text-base text-slate-300 hover:text-white">Converse</a>
                    <a href="<?php echo e(route('convert')); ?>" class="block text-base text-slate-300 hover:text-white">Convert</a>
                </div>
                
                <a href="<?php echo e(route('blog')); ?>" class="block text-lg font-medium text-white hover:text-gold-500 tracking-wide border-b border-white/10 pb-2 pt-2">BLOG</a>
                <a href="<?php echo e(route('careers')); ?>" class="block text-lg font-medium text-white hover:text-gold-500 tracking-wide border-b border-white/10 pb-2">CAREERS</a>
                
                <div class="pt-6">
                    <a href="<?php echo e(request()->routeIs('home') ? '#contact' : route('home').'#contact'); ?>" class="block w-full text-center bg-gold-500 text-navy-900 font-bold uppercase tracking-widest text-sm py-4 hover:bg-white transition-colors shadow-lg">Get Proposal</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-navy-900 text-slate-300 py-20 border-t border-gold-500/20 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid md:grid-cols-4 gap-12 lg:gap-16 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium">
                        <li><a href="<?php echo e(route('connect')); ?>" class="hover:text-gold-400 transition-colors flex items-center gap-2"><span class="w-1 h-1 bg-gold-500 rounded-full"></span>Connect</a></li>
                        <li><a href="<?php echo e(route('converse')); ?>" class="hover:text-gold-400 transition-colors flex items-center gap-2"><span class="w-1 h-1 bg-gold-500 rounded-full"></span>Converse</a></li>
                        <li><a href="<?php echo e(route('convert')); ?>" class="hover:text-gold-400 transition-colors flex items-center gap-2"><span class="w-1 h-1 bg-gold-500 rounded-full"></span>Convert</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium">
                        <li><a href="<?php echo e(route('about')); ?>" class="hover:text-gold-400 transition-colors">About Us</a></li>
                        <li><a href="<?php echo e(route('careers')); ?>" class="hover:text-gold-400 transition-colors">Careers</a></li>
                        <li><a href="<?php echo e(route('blog')); ?>" class="hover:text-gold-400 transition-colors">Blog</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#contact" class="hover:text-gold-400 transition-colors">Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
                <p>&copy; <?php echo e(date('Y')); ?> Nexus Beacon. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <?php if(session('success')): ?>
        <div x-data="{ show: true }" 
            ...
            <div>
                ...
                <p class="text-sm text-slate-600"><?php echo e(session('success')); ?></p>
            </div>
...
<?php /**PATH D:\nexus_becon\resources\views/layouts/app.blade.php ENDPATH**/ ?>