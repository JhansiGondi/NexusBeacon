...
<?php $__env->startSection('title', 'Convert | Appointments & Revenue'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="bg-navy-900 rounded-2xl p-10 text-white relative overflow-hidden shadow-2xl">
                     ...
                     <a href="<?php echo e(route('home')); ?>#contact" class="inline-block px-8 py-4 bg-gold-500 text-navy-900 font-bold uppercase tracking-widest rounded hover:bg-white transition-colors">Get Details</a>
                </div>
